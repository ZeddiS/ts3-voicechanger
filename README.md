...
TS3 plugin: real-time DSP for outgoing mic. Helium, Demon, Robot, Echo, Custom pitch slider.
...
|---|---|---|
| 3.5.0 | 23 | `VoiceChanger-v1.1.0-TS3-3.5.0-api23.zip` |
| 3.5.1 - 3.5.5 | 24 | `VoiceChanger-v1.1.0-TS3-3.5.1-3.5.5-api24.zip` |
| **3.5.6** | 25 | `VoiceChanger-v1.1.0-TS3-3.5.6-api25.zip` |
| 3.6.x+ | 26 | `VoiceChanger-v1.1.0-TS3-3.6+-api26.zip` |
